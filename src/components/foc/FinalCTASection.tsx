  ...
  return (
    <section className="py-24 md:py-32 text-center relative z-10" style={{ background: 'var(--red)' }}>
      <div className="px-6 lg:px-[7vw]">
        ...
        <p className="text-[16px] font-light leading-[1.75] max-w-[520px] mx-auto mb-10" style={{ color: 'rgba(255,255,255,0.7)' }}>
          Saiba exatamente onde sua administradora está vazando — em 30 minutos, de graça.
        </p>
        <button
          onClick={onOpenPopup}
          className="font-mono text-[13px] tracking-[0.08em] uppercase cursor-pointer transition-all duration-200 mx-auto block"
          style={{
            background: '#fff',
            color: 'var(--red)',
            padding: '18px 48px',
        ...
        <p className="font-mono text-[10px] mt-5" style={{ color: 'rgba(255,255,255,0.45)' }}>
