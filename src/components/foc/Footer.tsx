  ...
  return (
    <footer className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 px-6 lg:px-[7vw] py-9"
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-mono text-[11px] tracking-[0.08em]" style={{ color: 'var(--paper)' }}>SISTEMA FOC</span>
      </div>
      <p className="font-mono text-[10px] text-center" style={{ color: 'rgba(242,237,228,0.45)' }}>
