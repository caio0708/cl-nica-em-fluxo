  ...
  return (
    <section style={{ background: 'var(--ink)', color: 'var(--paper)' }} className="py-20 md:py-28 relative z-10">
      <div className="px-6 lg:px-[7vw] mb-14">
        ...
        <p className="text-[15px] font-light max-w-[600px] leading-[1.75]" style={{ color: 'rgba(242,237,228,0.55)' }}>
      ...
      <div className="px-6 lg:px-[7vw]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3" style={{ gap: '1px', background: 'rgba(242,237,228,0.08)' }}>
          {cards.map((card) => (
            ...
            >
              <span className="font-mono text-[10px] tracking-[0.2em] uppercase" style={{ color: 'var(--red)' }}>
                {card.num} — {card.cat}
              </span>
              <h3 className="font-body text-[16px] font-medium leading-[1.4]" style={{ color: 'var(--paper)' }}>
                {card.title}
              </h3>
              <p className="text-[13px] font-light leading-[1.7]" style={{ color: 'rgba(242,237,228,0.45)' }}>
                {card.desc}
              </p>
              <span className="font-mono text-[9px] tracking-[0.15em] uppercase mt-auto px-2 py-1 self-start"
